...
// Accept 'Spectator' role (capital S)
...
$full_name = $_SESSION['user']['full_name'] ?? 'Guest';
  ...
  <div class="header-top">
    <div class="user-info">
      ...
      <div class="user-details">
        ...
        <div class="user-role">Spectator • <?= htmlspecialchars($sport_name) ?></div>
      </div>
    </div>
...
<main class="mobile-content">
  ...
  <section class="tab-panel active" id="home">
    <div class="welcome-card">
      ...
      <p class="sport-focus">Viewing: <?= htmlspecialchars($sport_name) ?></p>
    </div>
    ...
    <div class="filter-section">
      <div class="filter-group">
        ...
        <select id="homeTournamentFilter" class="mobile-select">
    ...
    <div class="standings-list" id="homeStandingsList">
      <div class="loading">Loading standings...</div>
    </div>
  </section>

  <!-- MATCHES TAB -->
  <section class="tab-panel" id="matches">
    <div class="section-header">
    ...
    <div class="filter-section">
      <div class="filter-group">
        <label class="filter-label">Tournament</label>
        <select id="matchTournamentFilter" class="mobile-select">
          <option value="">All Tournaments</option>
        </select>
      </div>
      <div class="filter-group">
        <label class="filter-label">Sport</label>
        <select id="matchSportFilter" class="mobile-select">
    ...
    <!-- Grouped Matches -->
    <div id="matchesGroupedList">
      <div class="loading">Loading matches...</div>
    </div>
  </section>

  <!-- STANDINGS TAB -->
  <section class="tab-panel" id="standings">
    <div class="section-header">
      <h3>Team Rankings</h3>
    </div>
    ...
    <div class="filter-section">
      <div class="filter-group">
        <label class="filter-label">Tournament</label>
        <select id="standingTournamentFilter" class="mobile-select">
          <option value="">Select Tournament</option>
        </select>
      </div>
      <div class="filter-group">
        <label class="filter-label">Sport</label>
        <select id="standingSportFilter" class="mobile-select">
  ...
  <section class="tab-panel" id="teams">
    ...
    <div class="filter-section">
      <div class="filter-group">
        <label class="filter-label">Sport</label>
        <select id="teamSportFilter" class="mobile-select">
          <option value="">All Sports</option>
        </select>
      </div>
    </div>
